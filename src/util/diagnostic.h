...
class DiagnosticReporter {
 public:
  void reportError(Location location, std::string message) { report(location, S_ERROR, message); }
  ...
  void reportHint(Location location, std::string message) { report(location, S_HINT, message); }
